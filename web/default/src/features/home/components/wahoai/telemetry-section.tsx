...
const BARS = [42, 66, 50, 86, 74, 94, 61, 78, 98, 69, 88, 76, 92, 57, 81, 70]
...
export function TelemetrySection() {
  ...
  const dashboardScale = useTransform(scrollYProgress, [0, 0.55, 1], [0.94, 1, 0.98])
    ...
    <section className='waho-section waho-section-dark' ref={ref}>
      ...
      <div className='waho-monitor'>
        <AnimateInView className='waho-monitor-copy'>
          ...
          <div className='waho-telemetry-chips' aria-label={t('Telemetry summary')}>
            <span>
              <strong>99.92%</strong>
              {t('success')}
            </span>
