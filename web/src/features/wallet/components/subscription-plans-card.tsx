                      ...
                      <div className='text-muted-foreground mt-1'>
                        ...
                        {totalAmount > 0 ? (
                          <Tooltip>
                            ...
                            >
                              {formatSubscriptionQuotaUSD(usedAmount)}/
                              {formatSubscriptionQuotaUSD(totalAmount)} ·{' '}
                              {t('Remaining')}{' '}
                              {formatSubscriptionQuotaUSD(remainAmount)}
                            </TooltipTrigger>
                            <TooltipContent>
        ...
        {plans.length > 0 ? (
          <div className='grid grid-cols-1 gap-3 2xl:grid-cols-2 2xl:gap-4'>
            {plans.map((p, index) => {
              ...
              const price = formatSubscriptionPriceCNY(
              ...
              const benefits = [
                ...
                formatResetPeriod(plan, t) !== t('No Reset')
                  ...
                  : null,
                totalAmount > 0
                  ? `${t('Total Quota')}: ${formatSubscriptionQuotaUSD(totalAmount)}`
